...
htmlhelp_basename = 'cdshealpixdoc'
...
latex_documents = [
    (master_doc, 'cdshealpix.tex', 'cdshealpix Documentation',
     'François-Xavier Pineau, Matthieu Baumann', 'manual'),
]
...
man_pages = [
    (master_doc, 'cdshealpix', 'cdshealpix Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cdshealpix', 'cdshealpix Documentation',
     author, 'cdshealpix', 'One line description of project.',
     'Miscellaneous'),
]
